...
setup(
    ...
    entry_points={
        "console_scripts": [
            "map_service = smartnav_brain.map_service_node:main",
            "waypoint_service = smartnav_brain.waypoint_service_node:main",
            "navigation_action = smartnav_brain.navigation_action_node:main",
        ],
    },
)
