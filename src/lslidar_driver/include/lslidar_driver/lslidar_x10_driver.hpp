...
namespace lslidar_driver {
    ...
    public:
        ...
        std::vector<LslidarX10Driver::AngleRange> disableAngles{};
        std::vector<LslidarX10Driver::AngleRange> mergeRanges(std::vector<LslidarX10Driver::AngleRange>& ranges);
        std::vector<LslidarX10Driver::AngleRange> calculateDisableAngles(const std::vector<long int>& disableMin, const std::vector<long int>& disableMax);
